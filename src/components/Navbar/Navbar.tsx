        ...
        <Sheet>
          ...
          <SheetContent side="left">
            <div className="grid gap-2 py-6">
              ...
              <Link href="/resume" className="flex w-full items-center py-2 text-lg font-semibold" >
                Resume
              </Link>
              <Link href="/certificate" className="flex w-full items-center py-2 text-lg font-semibold" >
                Certifications
              </Link>
